...
training_tuples = [
    ...
    # EfficientNet
    # CIFAR10
    TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b0', num_classes=10), 'efficientnet-b0',
                  DatasetTuple(data.CIFAR10, 224), 32),
    TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', num_classes=10), 'efficientnet-b1',
                  DatasetTuple(data.CIFAR10, 240), 16),
    TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', num_classes=10), 'efficientnet-b2',
                  DatasetTuple(data.CIFAR10, 260), 16),
    TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', num_classes=10), 'efficientnet-b3',
                  DatasetTuple(data.CIFAR10, 300), 8),
    # CIFAR100
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b0', no_classes=100), 'efficientnet-b0', DatasetTuple(data.CIFAR100, 224), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', no_classes=100), 'efficientnet-b1', DatasetTuple(data.CIFAR100, 240), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', no_classes=100), 'efficientnet-b2', DatasetTuple(data.CIFAR100, 260), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', no_classes=100), 'efficientnet-b3', DatasetTuple(data.CIFAR100, 300), 32),
    # FLOWERS
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b0', no_classes=102), 'efficientnet-b0', DatasetTuple(data.FLOWERS, 224), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', no_classes=102), 'efficientnet-b1', DatasetTuple(data.FLOWERS, 240), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', no_classes=102), 'efficientnet-b2', DatasetTuple(data.FLOWERS, 260), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', no_classes=102), 'efficientnet-b3', DatasetTuple(data.FLOWERS, 300), 32),
    # AIRCRAFT
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b0', no_classes=100), 'efficientnet-b0', DatasetTuple(data.FGVC_AIRCRAFT, 224), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', no_classes=100), 'efficientnet-b1', DatasetTuple(data.FGVC_AIRCRAFT, 240), 16),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', no_classes=100), 'efficientnet-b2', DatasetTuple(data.FGVC_AIRCRAFT, 260), 16),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', no_classes=100), 'efficientnet-b3', DatasetTuple(data.FGVC_AIRCRAFT, 300), 8),
    # FOOD
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b0', no_classes=101), 'efficientnet-b0', DatasetTuple(data.FOOD, 224), 32),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', no_classes=101), 'efficientnet-b1', DatasetTuple(data.FOOD, 240), 16),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', no_classes=101), 'efficientnet-b2', DatasetTuple(data.FOOD, 260), 16),
    # TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', no_classes=101), 'efficientnet-b3', DatasetTuple(data.FOOD, 300), 8),
]
