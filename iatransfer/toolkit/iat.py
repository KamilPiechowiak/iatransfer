...
class IAT(ABC):
    ...
    def __new__(cls,
        ...
        ctx._standardization_classes = _get_subclasses(Standardization)
        ctx._matching_classes = _get_subclasses(Matching)
        ctx._transfer_classes = _get_subclasses(Transfer)
        ctx._score_classes = _get_subclasses(Score)
