...
training_tuples = [
  ...
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', num_classes=10), 'efficientnet-b1', DatasetTuple(data.CIFAR10, 240), 32),
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', num_classes=10), 'efficientnet-b2', DatasetTuple(data.CIFAR10, 260), 32),
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', num_classes=10), 'efficientnet-b3', DatasetTuple(data.CIFAR10, 300), 32),
  #CIFAR100
  ...
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', num_classes=100), 'efficientnet-b1', DatasetTuple(data.FGVC_AIRCRAFT, 240), 32),
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', num_classes=100), 'efficientnet-b2', DatasetTuple(data.FGVC_AIRCRAFT, 260), 32),
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', num_classes=100), 'efficientnet-b3', DatasetTuple(data.FGVC_AIRCRAFT, 300), 32),
  #FOOD
  ...
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b1', num_classes=101), 'efficientnet-b1', DatasetTuple(data.FOOD, 240), 32),
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b2', num_classes=101), 'efficientnet-b2', DatasetTuple(data.FOOD, 260), 32),
  TrainingTuple(lambda: EfficientNet.from_name('efficientnet-b3', num_classes=101), 'efficientnet-b3', DatasetTuple(data.FOOD, 300), 32),
]
